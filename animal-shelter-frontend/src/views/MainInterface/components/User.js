...
const User = props => {
    ...
    return (
        <div>
                    ...
                    <Fade {...TransitionProps} timeout={350}>
                        <Paper className={classes.profileContainer}>
                            <div style={{ display: "flex" }}>
                                <AccountCircle style={{ float: "left", marginRight: "7px" }} />
                                <h3 className={classes.typography}>{props.profile.name}</h3>
                            </div>
                            <div style={{ display: "flex", marginTop: "7px" }}>
                                <EmailIcon style={{ float: "left", marginRight: "7px" }} />
                                <p className={classes.typography}>{props.profile.email}</p>
                            </div>
                            <div style={{ display: "flex", marginTop: "7px" }}>
                                <LocationIcon style={{ float: "left", marginRight: "7px" }} />
                                <p className={classes.typography}>{props.profile.location}</p>
                            </div>
                            <div style={{ display: "flex", marginTop: "7px" }}>
                                <DecriptionIcon style={{ float: "left", marginRight: "7px" }} />
                                <p className={classes.typography}>{props.profile.description}</p>
                            </div>
                            ...
                            <div style={{ textAlign: "center", marginTop: "12px", marginBottom: "-16px" }}>
                                <Button onClick={() => logout()} variant="contained" color="default" className={classes.button} startIcon={<ExitToAppIcon />}>
                                    Logout
                                </Button>
                            </div>
                        </Paper>
            ...
            <a style={{ cursor: "pointer" }} onClick={handleClick("bottom-end")}>
